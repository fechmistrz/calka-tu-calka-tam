...
\input{sections/makefile-problems/gamma_beta}

\section{Całkowanie konturowe itd.}
\input{sections/makefile-problems/complex}
...
\section{Funkcje Gamma oraz Beta}
\input{sections/makefile-solutions/gamma_beta}
