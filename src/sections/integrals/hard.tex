...
% TODO: znajdź lepsze miejsce
\begin{problem_with_solution}
\label{nahin_page_231}%
    \begin{equation}
        \int_0^{\pi/2} x \log (\sin x) \,\mathrm{d}x = \frac{7}{16} \zeta(3) - \frac{\pi^2}{8} \log 2.
    \end{equation}
\end{problem_with_solution}

% SOLUTION
\textbf{Problem \ref{nahin_page_231}}.
Patrz Nahin \cite[s. 231-234]{nahin15}.
% SOLUTION
...
% TODO: znajdź lepsze miejsce
\begin{problem_with_solution}
\label{nahin_page_241}%
    \begin{equation}
        \int_0^{\infty} \frac{\cos x}{\sqrt{x}} = \int_0^{\infty} \frac{\sin x}{\sqrt{x}} = \sqrt{\frac{\pi}{2}}.
    \end{equation}
\end{problem_with_solution}

% SOLUTION
\textbf{Problem \ref{nahin_page_241}}.
Patrz Nahin \cite[s. 241]{nahin15}.
% SOLUTION
...
% SOLUTION
\textbf{Problem \ref{nahin_page_242}}.
Patrz Nahin \cite[s. 241-242]{nahin15}.
% SOLUTION
...
% TODO: znajdź lepsze miejsce
\begin{problem_with_solution}
\label{nahin_page_243}%
    \begin{equation}
        \int_0^{\infty} \left(\frac{\sin x}{x}\right)^3 \,\mathrm{d}x = \frac{3 \pi}{8}.
    \end{equation}
\end{problem_with_solution}

% SOLUTION
\textbf{Problem \ref{nahin_page_243}}.
Patrz Nahin \cite[s. 243]{nahin15}.
% SOLUTION
...
% TODO: znajdź lepsze miejsce
\begin{problem_with_solution}
\label{nahin_page_246}%
    \begin{equation}
        \int_0^{\infty} \left(\frac{(\sin x)^{2n-1}}{x}\right) \,\mathrm{d}x = \frac{\pi}{2^{2n-1}} \cdot {2n-2 \choose n-1}.
    \end{equation}
\end{problem_with_solution}

% SOLUTION
\textbf{Problem \ref{nahin_page_246}}.
Patrz Nahin \cite[s. 246]{nahin15}.
% SOLUTION
...
% TODO: znajdź lepsze miejsce
\begin{problem_with_solution}
\label{nahin_page_248}%
    \begin{equation}
        \int_0^{\infty} \left(\frac{(\sin x)^{2n-1} \cos x}{x}\right) \,\mathrm{d}x = \frac{\pi}{2^{2n} \cdot n} \cdot {2n-2 \choose n-1}.
    \end{equation}
\end{problem_with_solution}

% SOLUTION
\textbf{Problem \ref{nahin_page_248}}.
Patrz Nahin \cite[s. 248]{nahin15}.
% SOLUTION
...
% TODO: znajdź lepsze miejsce
\begin{problem_with_solution}
\label{nahin_page_251}%
    \begin{equation}
        \int_0^{\infty} \left(\frac{(\sin x)}{x}\right)^4 \,\mathrm{d}x = \frac{\pi}{3}.
    \end{equation}
\end{problem_with_solution}

% SOLUTION
\textbf{Problem \ref{nahin_page_251}}.
Patrz Nahin \cite[s. 251]{nahin15}.
% SOLUTION
...
% TODO: znajdź lepsze miejsce
\begin{problem_with_solution}
\label{nahin_page_252}%
    \begin{equation}
        \int_0^{\infty} \left(\frac{(\sin^3 x)}{x^2}\right)\,\mathrm{d}x = \frac{3}{4} \log 3.
    \end{equation}
\end{problem_with_solution}

% SOLUTION
\textbf{Problem \ref{nahin_page_252}}.
Patrz Nahin \cite[s. 252]{nahin15}.
% SOLUTION
...
% TODO: znajdź lepsze miejsce
\begin{problem_with_solution}
\label{nahin_page_257}%
    \begin{equation}
        \int_0^{\infty} \frac{(\sin \alpha x) \cdot (\sin \beta x)}{x^2} \,\mathrm{d} x = \pi \cdot \min(a, b).
    \end{equation}
\end{problem_with_solution}

% SOLUTION
\textbf{Problem \ref{nahin_page_257}}.
Patrz Nahin \cite[s. 257]{nahin15}.
% SOLUTION
