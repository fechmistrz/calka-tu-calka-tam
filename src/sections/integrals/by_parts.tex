...
\begin{problem_with_solution}
\label{nahin_page_226}%
    \begin{equation}
		\int_0^\infty \sin (\beta x) \exp (-xy) \,\mathrm{d}x = \frac{b}{y^2 + b^2}.
    \end{equation}
\end{problem_with_solution}

% SOLUTION
\textbf{Problem \ref{nahin_page_226}}.
Skorzystać ze wzoru $\sin \theta = \frac{1}{2i} (\exp \theta i - \exp (-\theta i))$ jak Nahin \cite[s. 226]{nahin15}.
% SOLUTION
